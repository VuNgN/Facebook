      ...
      <div class="container">
        ...
        <section class="py-2 d-flex justify-content-between">
          ...
          <div>
            ...
            <button type="button" class="btn btn-link bg-light" datadata-ripple-color="dark" onclick="document.location.href='index.php?controller=profile&action=viewImage'">
              Ảnh
            </button>
